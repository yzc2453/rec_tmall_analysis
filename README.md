...
## 📈 核心数据洞察
1. **用户活跃规律**：晚间 19:00-22:00 是用户购物行为高峰期，占全天行为量的 35%+
2. **转化效率**：点击→购买整体转化率约 2.8%，加购→购买转化率最高（15.6%）
3. **品类特征**：孕妇装、美妆、3C 数码类商品用户行为量位列前三
4. **用户分层**：低活跃用户（行为<10次）占比 78%，高活跃用户复购率达 23%
